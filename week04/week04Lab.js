...
let drink = "beers";
let myName = "Paul";
let friendName = "Shane";

//Question: Name a reason why you would use const instead of let.
//Answer: We would use const if we do not want the value of the variable to change.
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log (`${friendName} and ${myName} are eating ${food} and ${drink}.`)
...
Answer: console.log (friendName + " and " + myName + " are eating " + food + " and " + drink + ".")
console.log(`-------------------------- 
Question 2a: Oh no`)
...
//Answer: we used a constant variable so we can't assign it a new value. 
...
const lunchTime = (foodChoice, drinkChoice) => {return `${friendName} and ${myName} are eating ${foodChoice} and ${drinkChoice}.` }
console.log(lunchTime('Pizza','Water'));
//Question: What would your function look like if we were using the old way of creating a function?
//Answer: function lunchtime (foodChoice, drinkChoice) {   return `${friendName} and ${myName} are eating ${foodChoice} and ${drinkChoice}.` }
...
console.log (foodForTodayAndTomorrow('Gyros', 'whiskey',lunchTime('turkey', 'mead') ))
